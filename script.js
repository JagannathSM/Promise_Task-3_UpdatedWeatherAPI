...
function current_weather_card(city_name,state_name,country_name,current_temp,current_precipitation,currrent_wind_speed,current_wind_dir,current_summary,reset_val){
    ...
    col_1.innerHTML = ` <div class="card bg-dark text-white">
                            ...
                            <div class="card-img-overlay">
                                <h3 class="card-title"><b>CURRENT WEATHER REPORT - <i class="fa fa-map-marker" aria-hidden="true"></i> ${city_name} / ${state_name} / ${country_name}</b></h3>
                                ...
                                <p class="card-text"><b>Summary - ${current_summary}</b></p>
                                <div class="card-text button_div">
                                    <button type="button" class="btn btn-dark" onclick="dailydisplay(${reset_val})">Show Daily Weather report</button>
                                    <button type="button" class="btn btn-dark" onclick="hourlydisplay(${reset_val})">Show Hourly Weather report</button>
                                </div>
                            </div>
                        </div>`
